              ...
              <Card key={block.id} className="p-5 md:p-6">
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-peach text-white text-xs font-semibold hover:opacity-90 transition disabled:opacity-50"
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center w-8 h-8 rounded-lg text-slate-400 hover:text-ink hover:bg-stone-100 transition"
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full mt-4 px-4 py-2.5 rounded-xl border border-stone-200/70 bg-white text-sm focus:outline-none focus:border-peach transition resize-y"
